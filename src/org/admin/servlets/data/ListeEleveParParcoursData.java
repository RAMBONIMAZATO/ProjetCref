...
@WebServlet("/liste_etudiant_data")
public class ListeEleveParParcoursData extends BaseServlet{
	private static final long serialVersionUID = 1L;
	private StudentDao studentDao;
	private ParcoursDao parcoursDao;
	private CursusDao cursusDao;

	public ListeEleveParParcoursData(){
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException{
		...
		String content="../inscription/etudiantAutorise.jsp";
		...
		try{
			...
			if(session.getAttribute("utilisateur") == null){
				...
				List<Student> students = studentDao.getAllStudentByParcoursAuthorized(parcours,niveau);
