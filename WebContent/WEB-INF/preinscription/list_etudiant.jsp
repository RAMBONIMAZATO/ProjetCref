                      ...
                      <tbody>
                        <c:forEach var="etudiant" items="${etudiants}">
                          <tr>
                              ...
                              <td>
                                    <button type="button" class="btn btn-success modaly" data-toggle="modal" data-target="#details_${etudiant.id_etudiant}">
                                      Détails
                                    </button>
                              </td>
                              <td>
                              ...
                              <td>
                                 <form method="post" action="cursus">
                                    ...
                                    <button type="button" class="btn btn-success modaly" data-toggle="modal" data-target="#cursus_${etudiant.id_etudiant}">
                                      Cursus
                                    </button>
                                </form>
                              </td>
                              ...
                              <td>
                                 <form method="post" action="#">
                                    <input type="submit" class="btn btn-primary" value="RN" />
                                </form>
                              </td>
